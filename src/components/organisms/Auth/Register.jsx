    ...
    <div className="flex justify-center items-center h-screen">
        <div className="bg-white p-8 rounded shadow-md w-1/4 text-center">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                    <label htmlFor="date" className="block text-gray-700 text-sm font-bold mb-2">Date de naissance</label>
                ...
                <div className="mb-4">
                    <label htmlFor="password" className="block text-gray-700 text-sm font-bold mb-2">Confirmer le mot de
                        passe</label>
